...
def MoliereDist(datafile, outfile):
    ...
    sdir = '/data/neutrino03/jnugent/Unfolding/Cobb_results/moliere/test'
    ...
    for x in range(0,798,2):
        ...
        datahalf.append([m, data[x][1], (data[x][2]+data[x+1][2])/4,data[x][3]])
        m += 1
    ...
    # print len(x2bins)
    # for x in range(len(x2bins)):
    #     print x2bins[x]
    # for x in range(399):
    #     data.pop()

    # for d in data:
    #     hthetaX.SetBinContent(-d[0]+800, d[2])
    # data.pop()
    # data.pop()
    # data.pop(0)
    # for d in data:
    #     print x2bins[d[0]]
        # hthetaX.SetBinContent(-d[0]+len(data), d[2])
        # hthetaX.SetBinContent(d[0]+len(data), d[2])
        # hthetaX.SetBinContent(d[0]+1, d[2])
        # hthetaX.SetBinContent(-d[0]+2+len(data)*2, d[2])
        # hthetaX.SetBinContent(d[0] + 1, d[2])
    ...
    for d in range(0,399,1):
        print datahalf[d][0]+1,datahalf[d][2]
...
if __name__ == '__main__':
    ...
    MoliereDist('LiH-6p5-200-Molprj-fine.dat','LiH-6p5-200-Mol-fine.root')
