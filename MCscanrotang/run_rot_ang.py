...
def submitUnfolding(xmlfile):
    execdir = "/data/neutrino03/jnugent/Unfolding/MCscanrotang"
...
def submit_to_batch(xmlfile):
    ...
    maus_root_dir = "/data/neutrino03/jnugent/Unfolding/MCscanrotang"
...
for i in np.arange(-0.001,0.001,0.0002):
    '''
    updatefilename("rot_ang_0/LiHMu_3172_0.xml",
                   "rot_ang_0/LiHMu_3172_"+str(i)+".xml",
                   "rot_ang_0/LiHMu_3172_"+str(i)+".root")
    updatesysval("rot_ang_0/LiHMu_3172_"+str(i)+".xml",
                 "rot_ang_0/LiHMu_3172_"+str(i)+".xml",
                 "rot_ang", i)
    submit_to_batch("rot_ang_0/LiHMu_3172_"+str(i)+".xml")
    '''
    updatefilename("rot_ang_0/LiHMu_3200_0.xml",
                   "rot_ang_0/LiHMu_3200_"+str(i)+".xml",
                   "rot_ang_0/LiHMu_3200_"+str(i)+".root")
    updatesysval("rot_ang_0/LiHMu_3200_"+str(i)+".xml",
                 "rot_ang_0/LiHMu_3200_"+str(i)+".xml",
                 "rot_ang", i)
    updatesysval("rot_ang_0/LiHMu_3200_"+str(i)+".xml",
                 "rot_ang_0/LiHMu_3200_"+str(i)+".xml",
                 "rot_ang_empty", i)
    submit_to_batch("rot_ang_0/LiHMu_3200_"+str(i)+".xml")
    '''
    updatefilename("rot_ang_0/LiHMu_3240_0.xml",
                   "rot_ang_0/LiHMu_3240_"+str(i)+".xml",
                   "rot_ang_0/LiHMu_3240_"+str(i)+".root")
    updatesysval("rot_ang_0/LiHMu_3240_"+str(i)+".xml",
                 "rot_ang_0/LiHMu_3240_"+str(i)+".xml",
                 "rot_ang", i)
    submit_to_batch("rot_ang_0/LiHMu_3240_"+str(i)+".xml")
    '''
    '''
    updatefilename("rot_ang_0/XePion_3240.xml",
                   "rot_ang_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                   "rot_ang_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".root")
    updatesysval("rot_ang_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "rot_ang_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "resX", llim_240 + i*0.0109)
    updatesysval("rot_ang_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "rot_ang_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "resY", llim_240 + i*0.0109)
    submit_to_batch("rot_ang_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml")
