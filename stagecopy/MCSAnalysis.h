...
class MCSAnalysis {
 public:
  ...
  //TTree* GetTree(){ return chain; }
  //TTree* GetRefTree(){ return refchain; }
  //TTree* GetMCTree(){ return mcchain; }
  //TTree* GetMCEmptyTree(){ return mcemptychain; }
  //void SetTree(TTree* a){ chain=a; }
  //void SetRefTree(TTree* a){ refchain=a; }
  //void SetMCTree(TTree* a){ mcchain=a; }
  //void SetMCEmptyTree(TTree* a){ mcemptychain=a; }
  //TFileInfo* GetFileInfo(){ return fileinfo;}
  void StageData(TString treename, TString fn);
  void StageRefData(TString treename, TString fn);
  void StageMCData(TString treename, TString fn);
  void Execute(int mode);
  void dataSelection(int mode, TTree* tree);
  void referenceSelection(TTree* reftree);
  void generateMCSResponse(TTree* mctree);
  void TruthData(int mode, TTree* mctree);
 ...
 private:
  ...
  Collection USAllTOF;
  Collection DSAllTOF;
  Collection USPreRadSel;
  Collection DSPreRadSel;
  Collection USAllTOFEmpty;
  Collection DSAllTOFEmpty;
  Collection USPreRadSelEmpty;
  Collection DSPreRadSelEmpty;
