...
t1 = TText(0.18,0.8,"MICE Internal")
t3 = TText(0.18,0.765,"ISIS cycle 2015/04")
t2 = TText(0.18,0.73,"LiH, MAUS v3.3.2")
t1.SetNDC(1)
t1.SetTextSize(0.04)
t1.SetTextFont(42)
t2.SetNDC(1)
...
tof01_0.GetYaxis().SetRangeUser(0,1.5e4)
tof01_0.GetYaxis().SetTitle("Events per 0.2 ns")
tof01_0.GetXaxis().SetTitle("t_{TOF1} - t_{TOF0} (ns)")
...
leg.AddEntry(tof01_2,"240 MeV/c","f")
'''
# tof21_0.SetTitle("LiH Abs., Muon Beams, March 2016, MAUS v3.3.2")
...
leg.AddEntry(tof01_2,"240 MeV/c","f")
'''
# mctof10_0.SetTitle("LiH Abs., Muon Beams, March 2016, MAUS v3.3.2")
