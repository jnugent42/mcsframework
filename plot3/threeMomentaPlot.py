...
t2 = TText(0.18,0.85,"LiH, MAUS v2.9.1")
t1.SetNDC(1)
t1.SetTextSize(0.04)
t1.SetTextFont(42)
t2.SetNDC(1)
...
t3.SetTextSize(0.04)
t3.SetTextFont(42)
t4 = TText(0.18,0.85,"Xenon, Pion Beam, MAUS v2.9.1")
t4.SetNDC(1)
t4.SetTextSize(0.03)
t4.SetTextFont(42)
h3.SetLineColor(4)
...
t5 = TText(0.18,0.85,"Helium, Pion Beam, MAUS v2.9.1")
t5.SetNDC(1)
t5.SetTextSize(0.03)
t5.SetTextFont(42)
hz3.SetLineColor(4)
...
t6 = TText(0.18,0.85,"Zero Abs., Muon Beams, MAUS v2.9.1")
t6.SetNDC(1)
t6.SetTextSize(0.03)
t6.SetTextFont(42)
t1.Draw()
...
t7.SetTextSize(0.04)
t7.SetTextFont(42)
t8 = TText(0.18,0.85,"LiH, Muon Beams, MAUS v2.9.1")
t8.SetNDC(1)
t8.SetTextSize(0.03)
t8.SetTextFont(42)
t7.Draw()
...
t90.SetTextFont(42)
t10 = TText(0.38,0.15,"LiH, Muon Beams, MAUS v2.9.1")
t10.SetNDC(1)
...
t9.SetTextSize(0.04)
t9.SetTextFont(42)
t10 = TText(0.18,0.85,"LiH, Muon Beams, MAUS v2.9.1")
t10.SetNDC(1)
t10.SetTextSize(0.03)
t10.SetTextFont(42)
t9.Draw()
...
t7.SetTextSize(0.04)
t7.SetTextFont(42)
t8 = TText(0.18,0.85,"LiH, MAUS v2.9.1")
t8.SetNDC(1)
t8.SetTextSize(0.03)
t8.SetTextFont(42)
t7.Draw()
...
t70.SetTextFont(42)
t80 = TText(0.18,0.85,"LiH, Muon Beams, MAUS v2.9.1")
t80.SetNDC(1)
...
# tof01_0.SetTitle("LiH Abs., Muon Beams, March 2016, MAUS v2.9.1")
tof01_0.GetXaxis().SetRangeUser(24,33)
tof01_0.GetYaxis().SetRangeUser(0,1.25e5)
...
# accept_0.SetTitle("LiH Abs., Muon Beams, March 2016, MAUS v2.9.1")
...
# XY_10.SetTitle("TkU Station 1, LiH 200 MeV/c, March 2016, MAUS v2.9.1")
XY_10.SetStats(0)
XY_10.SetTitle("")
...
# XY_11.SetTitle("TkU Station 1, LiH 200 MeV/c, March 2016, MAUS v2.9.1")
XY_11.SetStats(0)
XY_11.SetTitle("")
...
# XY_12.SetTitle("TkU Station 1, LiH 200 MeV/c, March 2016, MAUS v2.9.1")
XY_12.SetStats(0)
XY_12.SetTitle("")
...
# dXdzdYdz_10.SetTitle("TkU Station 1, LiH 200 MeV/c, March 2016, MAUS v2.9.1")
...
# dXdzdYdz_11.SetTitle("TkU Station 1, LiH 200 MeV/c, March 2016, MAUS v2.9.1)"
...
# dXdzdYdz_12.SetTitle("TkU Station 1, LiH 200 MeV/c, March 2016, MAUS v2.9.1")
...
t2 = TText(0.18,0.85,"Zero Abs., February 2016, MAUS v2.9.1")
t2.SetNDC(1)
t2.SetTextSize(0.03)
t2.SetTextFont(42)
...
for hist in morehist:
    ...
    h = f1.Get(hist)
    print hist
    # h.SetTitle("TkU Station 1, LiH 200 MeV/c, March 2016, MAUS v2.9.1")
    h.SetStats(0)
    h.SetTitle("")
    # h.SetMaximum(300)
    h.SetMinimum(0)
