...
def submitUnfolding(xmlfile):
    execdir = "/data/neutrino03/jnugent/Unfolding/alignment"
...
def submit_to_batch(xmlfile):
    ...
    maus_root_dir = "/data/neutrino03/jnugent/Unfolding/alignment"
    ...
    #q = subprocess.Popen(settings['shellscript'], shell=True)
...
for i in range(-1,2,2):
    ...
    # updatesysval("LiHMu_3172_"+str(i)+".xml","LiHMu_3172_"+str(i)+".xml", "alYDS", -0.118 + rndm.Gaus(0, 0.24))
     updatesysval("LiHMu_3172.xml","LiHMu_3172_"+str(i)+".xml", "thYUS", 0.0031 +  rndm.Gaus(0, 0.004))
...
for i in range(-1,2,2):
    ...
    updatesysval("LiHMu_3200_6.xml","LiHMu_3200_"+str(i)+".xml", "thYUS",  -0.0031 +  0.01*rndm.Rndm() - 0.005)
...
for i in range(-1,2,2):
    ...
    updatesysval("LiHMu_3240.xml","LiHMu_3240_"+str(i)+".xml", "thYUS", 0.0031 +  rndm.Gaus(0, 0.004))
