    ...
    def MCSPlot(self, pname):
        ...
        for histvar in self.histvarnames:
            ...
            if self.desc[0] == 'XePion':
                ...
                t2 = TText(0.18,0.85,"Xe, "+self.desc[1][2:5]+", MAUS v2.5")
            else:
                t1 = TText(0.18,0.885,"MICE isis cycle 2015/04")
                t2 = TText(0.18,0.85,"LiH, "+self.desc[1][2:5]+", MAUS v2.5")
            t1.SetNDC(1)
            t1.SetTextSize(0.04)
            t1.SetTextFont(42)
            t2.SetNDC(1)
...
if __name__ == '__main__':
    ...
    raw172.sysFiles = [["TOFsys/LiHMu_3172_tof_lim28.7374090796_u28.9374090796.root",
                        ...
                        129./800.,"TOF"],
                       ["material_0/LiHMu_3172_res_lim0.891.root",
                        "material_0/LiHMu_3172_res_lim1.109.root",
                        sqrt(0.004/0.218),"Material"],
                       ["fiducial_0/LiHMu_3172_R_5_G_1.root",
                        "fiducial_0/LiHMu_3172_R_5_G_3.root",
                        0.5/10,"Fid. Pitch"],
                       ["fiducial_0/LiHMu_3172_R_4_G_2.root",
                        "fiducial_0/LiHMu_3172_R_6_G_2.root",
                       .478/20.,"Fid. Radius"],
    ...
    raw200.sysFiles = [["TOFsys/LiHMu_3200_tof_lim27.8059285384_u28.0059285384.root",
                        ...
                        129./800.,"TOF"],
                       ["material_0/LiHMu_3200_res_lim0.891.root",
                        "material_0/LiHMu_3200_res_lim1.109.root",
                        sqrt(0.004/0.218),"Material"],
                       ["fiducial_0/LiHMu_3200_R_5_G_0.root",
                        "fiducial_0/LiHMu_3200_R_5_G_2.root",
                        0.5/10,"Fid. Pitch"],
                       ["fiducial_0/LiHMu_3200_R_4_G_1.root",
                        "fiducial_0/LiHMu_3200_R_6_G_1.root",
                        0.478/20.,"Fid. Radius"],
    ...
    raw240.sysFiles = [["TOFsys/LiHMu_3240_tof_lim27.0570317938_u27.2570317938.root",
                        ...
                        129./800.,"TOF"],
                       ["material_0/LiHMu_3240_res_lim0.891.root",
                        "material_0/LiHMu_3240_res_lim1.109.root",
                        sqrt(0.004/0.218),"Material"],
                       ["fiducial_0/LiHMu_3240_R_5_G_0.root",
                        "fiducial_0/LiHMu_3240_R_5_G_2.root",
                        0.5/10,"Fid. Pitch"],
                       ["fiducial_0/LiHMu_3240_R_4_G_1.root",
                        "fiducial_0/LiHMu_3240_R_6_G_1.root",
                        0.478/20.,"Fid. Radius"],
