...
def submitUnfolding(xmlfile):
    print xmlfile
    execdir = "/afs/phas.gla.ac.uk/user/j/jnugent/workarea/Unfolding/TOFScan"
...
# python %(modelcmd)s %(mcfile)s %(modelfile)s
%(execcmd)s %(xmlfile)s
'''% settings
...
def submit_to_batch(xmlfile, runMC=False):
    ...
    maus_root_dir = "/afs/phas.gla.ac.uk/user/j/jnugent/workarea/Unfolding/TOFScan"
...
for i in range(-10,10):
    ...
    updatedatafilename(\
        "TOFAllscan/LiHMu_3172_tof_lim"+str(llim_172 + i*0.2)+"_u"+str(ulim_172 + i*0.2)+".xml",
        "TOFAllscan/LiHMu_3172_tof_lim"+str(llim_172 + i*0.2)+"_u"+str(ulim_172 + i*0.2)+".xml", 
        "/data/neutrino02/jnugent/data_reduced/all/reduced_tree_LiH_03172.root")
    updatetrainfilename(\
        "TOFAllscan/LiHMu_3172_tof_lim"+str(llim_172 + i*0.2)+"_u"+str(ulim_172 + i*0.2)+".xml",
        "TOFAllscan/LiHMu_3172_tof_lim"+str(llim_172 + i*0.2)+"_u"+str(ulim_172 + i*0.2)+".xml",
        "/data/neutrino02/jnugent/data_reduced/allempty/reduced_tree_Abs_03172.root")
