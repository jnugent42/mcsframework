...
RooUnfoldTUnfold::GetCov()
{
  ...
  if (!_unf) return;
  TH2D* ematrix=new TH2D("ematrix","error matrix",
			 _meas->GetNbinsX(), _meas->GetXaxis()->GetXmin(), _meas->GetXaxis()->GetXmax(),
			 _meas->GetNbinsY(), _meas->GetYaxis()->GetXmin(), _meas->GetYaxis()->GetXmax());
