...
def calculate_efficiency() :
    ...
    EEE = "EEE"
    inf = ROOT.TFile("plot_"+str(TOF_ll)+"_"+str(EEE)+".root","READ")
    ...
    inf.Close()
    # f = ROOT.TFile("tracker_resolution_plots_"+str(TOF_ll)+"_"+str(EEE)+".root","RECREATE")
    ...
    inf.Close()
    # f = ROOT.TFile("tracker_resolution_plots_"+str(TOF_ll)+"_"+str(EEE)+".root","UPDATE")
    f = ROOT.TFile("tracker_resolution_plots_"+str(TOF_ll)+".root","UPDATE")
    c7 = ROOT.TCanvas()
