...
void powpeaks(Int_t np=1) {
   ...
   par[3*0+3] = 600;
   par[3*0+4] = 20+2;
   //TF1 *f = new TF1("f","1000-x+40",600,640);
   //TF1 *f2 = new TF1("f","x",560,600);
   TCanvas *c1 = new TCanvas("c1","c1",10,10,1000,900);
   c1->Divide(2,2);
   c1->cd(1);
   //h->FillRandom("f",200000);
   //h->FillRandom("f2",200000);
   for (i=225;i<251;i++) h->SetBinContent(i,i-225);
   for (i=251;i<276;i++) h->SetBinContent(i,275-i);
   h->Draw();
   
   TH1F *h2 = new TH1F("h","test",500,0,1000);
   ...
   TH1F *hcon = new TH1F("hcon","test",500,0,1000);
   for (int i=0;i<1e6;i++) {
   ...
   TH1F *hdecon = new TH1F("h","test",500,0,1000);
   Int_t i;
   Double_t xmin     = 0;
