...
def submitUnfolding(xmlfile):
    execdir = "/data/neutrino03/jnugent/Unfolding/accpscan"
...
def submit_to_batch(xmlfile):
    ...
    maus_root_dir = "/data/neutrino03/jnugent/Unfolding/accpscan"
...
for i in np.arange(-0.2,0.,0.01):
    '''
    updatefilename("accpt/LiHMu_3172_0.xml",
                   "accpt/LiHMu_3172_"+str(i)+".xml",
                   "accpt/LiHMu_3172_"+str(i)+".root")
    updatesysval("accpt/LiHMu_3172_"+str(i)+".xml",
                 "accpt/LiHMu_3172_"+str(i)+".xml",
                 "rot_ang", i)
    submit_to_batch("accpt/LiHMu_3172_"+str(i)+".xml")
    '''
    updatefilename("accpt/LiHMu_3200_0.xml",
                   "accpt/LiHMu_3200_"+str(i)+".xml",
                   "accpt/LiHMu_3200_"+str(i)+".root")
    updatesysval("accpt/LiHMu_3200_"+str(i)+".xml",
                 "accpt/LiHMu_3200_"+str(i)+".xml",
                 "accpt", i)
    submit_to_batch("accpt/LiHMu_3200_"+str(i)+".xml")
    '''
    updatefilename("accpt/LiHMu_3240_0.xml",
                   "accpt/LiHMu_3240_"+str(i)+".xml",
                   "accpt/LiHMu_3240_"+str(i)+".root")
    updatesysval("accpt/LiHMu_3240_"+str(i)+".xml",
                 "accpt/LiHMu_3240_"+str(i)+".xml",
                 "rot_ang", i)
    submit_to_batch("accpt/LiHMu_3240_"+str(i)+".xml")
    '''
    '''
    updatefilename("accpt/XePion_3240.xml",
                   "accpt/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                   "accpt/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".root")
    updatesysval("accpt/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "accpt/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "resX", llim_240 + i*0.0109)
    updatesysval("accpt/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "accpt/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "resY", llim_240 + i*0.0109)
    submit_to_batch("accpt/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml")
