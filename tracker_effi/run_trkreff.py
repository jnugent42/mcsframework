...
def submit_to_batch(xmlfile, j):
    execdir = "/data/neutrino03/jnugent/Unfolding/tracker_effi"
    execcmd = os.path.join(execdir,"../../MCSUnfolding")
    maus_root_dir = "/data/neutrino03/jnugent/Unfolding/tracker_effi"
...
updatefilename("lihmu_3172_5.xml",
            "lihmu_3172_5.xml",
            "/data/neutrino/jnugent/LiHMC/coectedoutput/",
            "datafile")
...
updatefilename("lihmu_3240_5.xml",
            "lihmu_3240_5.xml",
            "/data/neutrino01/jnugent/LiHMC/coctedoutput/",
            "datafile")
submit_to_batch("LiHMu_3172_5.xml")
submit_to_batch("LiHMu_3240_5.xml")
...
for i in range(-5,8):
    ...
    updatefilename("lihmu_3200_tof_lim"+str(llim_200 + i*0.2)+"_u"+str(ulim_200 + i*0.2)+".xml",
                "lihmu_3200_tof_lim"+str(llim_200 + i*0.2)+"_u"+str(ulim_200 + i*0.2)+".xml",
                "/data/neutrino01/jnugent/LiHMC/coectedoutput/",
                "trainfile")
    submit_to_batch("LiHMu_3200_tof_lim"+str(llim_200 + i*0.2)+"_u"+str(ulim_200 + i*0.2)+".xml", j)
