...
def calculate_efficiency() :
    ...
    EEE = "EEE"
    inf = ROOT.TFile("plot_"+str(27.8196160799)+"_"+str(EEE)+".root","READ")
    ...
    inf.Close()
    # f = ROOT.TFile("tracker_resolution_plots_"+str(27.8196160799)+"_"+str(EEE)+".root","RECREATE")
    f = ROOT.TFile("tracker_resolution_plots_"+str(27.8196160799)+".root","RECREATE")
    c5 = ROOT.TCanvas()
    ...
    inf.Close()
    # f = ROOT.TFile("tracker_resolution_plots_"+str(27.8196160799)+"_"+str(EEE)+".root","UPDATE")
    f = ROOT.TFile("tracker_resolution_plots_"+str(27.8196160799)+".root","UPDATE")
    c7 = ROOT.TCanvas()
