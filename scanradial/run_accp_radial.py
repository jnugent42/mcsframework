...
def submitUnfolding(xmlfile):
    execdir = "/data/neutrino03/jnugent/Unfolding/scanradial"
...
def submit_to_batch(xmlfile):
    ...
    maus_root_dir = "/data/neutrino03/jnugent/Unfolding/scanradial"
...
for i in np.arange(40,145,10):
    '''
    updatefilename("accp_rad_0/LiHMu_3172_0.xml",
                   "accp_rad_0/LiHMu_3172_"+str(i)+".xml",
                   "accp_rad_0/LiHMu_3172_"+str(i)+".root")
    updatesysval("accp_rad_0/LiHMu_3172_"+str(i)+".xml",
                 "accp_rad_0/LiHMu_3172_"+str(i)+".xml",
                 "fid_rad", i)
    submit_to_batch("accp_rad_0/LiHMu_3172_"+str(i)+".xml")
    '''
    updatefilename("accp_rad_0/LiHMu_3200_0.xml",
                   "accp_rad_0/LiHMu_3200_"+str(i)+".xml",
                   "accp_rad_0/LiHMu_3200_"+str(i)+".root")
    updatecutval("accp_rad_0/LiHMu_3200_"+str(i)+".xml",
                 "accp_rad_0/LiHMu_3200_"+str(i)+".xml",
                 "fid_rad", i)
    submit_to_batch("accp_rad_0/LiHMu_3200_"+str(i)+".xml")
    '''
    updatefilename("accp_rad_0/LiHMu_3240_0.xml",
                   "accp_rad_0/LiHMu_3240_"+str(i)+".xml",
                   "accp_rad_0/LiHMu_3240_"+str(i)+".root")
    updatesysval("accp_rad_0/LiHMu_3240_"+str(i)+".xml",
                 "accp_rad_0/LiHMu_3240_"+str(i)+".xml",
                 "fid_rad", i)
    submit_to_batch("accp_rad_0/LiHMu_3240_"+str(i)+".xml")
    '''
    '''
    updatefilename("accp_rad_0/XePion_3240.xml",
                   "accp_rad_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                   "accp_rad_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".root")
    updatesysval("accp_rad_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "accp_rad_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "resX", llim_240 + i*0.0109)
    updatesysval("accp_rad_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "accp_rad_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml",
                 "resY", llim_240 + i*0.0109)
    submit_to_batch("accp_rad_0/XePion_3240_res_lim"+str(llim_240 + i*0.0109)+".xml")
