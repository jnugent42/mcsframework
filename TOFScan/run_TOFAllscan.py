...
def submitUnfolding(xmlfile):
    print xmlfile
    execdir = "/home/ppe/j/jnugent/workarea/Unfolding/TOFScan"
...
def submit_to_batch(xmlfile, runMC=False):
    ...
    maus_root_dir = "/home/ppe/j/jnugent/workarea/Unfolding/TOFScan"
...
for i in range(-10,10):
    ...
    updatedatafilename(\
        "TOFAllscan/LiHMu_3172_tof_lim"+str(llim_172 + i*0.2)+"_u"+str(ulim_172 + i*0.2)+".xml",
        "TOFAllscan/LiHMu_3172_tof_lim"+str(llim_172 + i*0.2)+"_u"+str(ulim_172 + i*0.2)+".xml", 
        "/data/neutrino06/jnugent/v2.9.1/allLiH/reduced_tree_.root")
    updatetrainfilename(\
        "TOFAllscan/LiHMu_3172_tof_lim"+str(llim_172 + i*0.2)+"_u"+str(ulim_172 + i*0.2)+".xml",
        "TOFAllscan/LiHMu_3172_tof_lim"+str(llim_172 + i*0.2)+"_u"+str(ulim_172 + i*0.2)+".xml",
        "/data/neutrino06/jnugent/v2.9.1/allZeroAbs/reduced_tree_.root")
